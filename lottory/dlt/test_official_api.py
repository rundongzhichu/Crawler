...
def test_full_workflow():
    ...
    try:
        ...
        data_dir = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "data", date_str
        )
        os.makedirs(data_dir, exist_ok=True)
        test_filename = os.path.join(data_dir, "test_official_api_data.xlsx")
...
def main():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(
                os.path.join(log_dir, f"test_{date_str}.log"),
                encoding='utf-8'
            ),
